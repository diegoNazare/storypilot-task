    ...
    <div className="max-w-6xl mx-auto px-8 py-16 page-fade-in">
      ...
      <Section title="Interactive Architecture Diagram">
        <div className="bg-white p-6">
          ...
          <div className="border border-mist p-8 mb-6 bg-cloud mt-8">
            <p className="font-body text-xs font-bold uppercase mb-4">Text Representation (for reference)</p>
            <pre className="font-mono text-xs leading-relaxed whitespace-pre">
{`┌─────────────────────┐
│    Mobile SDK       │  (Host App Integration)
│  - Hashed User ID   │
│  - Event Tracking   │
└──────────┬──────────┘
           │
           │ GET /v1/feed?user_id=hash&tenant_id=...
           │
           ▼
┌─────────────────────┐
